      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            exact
            component={AlgorithmsTablePage}
          />
          <Route
            path={'/admin/algorithms/new'}
            exact
            component={AlgorithmsFormPage}
          />
          <Route
          ...
          <Route
            ...
            exact
            component={FederationTablePage}
          />
          <Route
            path={'/admin/federation/new'}
            exact
            component={FederationFormPage}
          />
          <Route
            path={'/admin/federation/:id/edit'}
            exact
            component={FederationFormPage}
          />
          ...
          <Route
            ...
            exact
            component={DeploymentTablePage}
          />
          <Route
            path={'/admin/deployment/new'}
            exact
            component={DeploymentFormPage}
          />
          <Route
            path={'/admin/deployment/:id/edit'}
            exact
            component={DeploymentFormPage}
          />
          ...
          <Route
            ...
            exact
            component={MonitoringTablePage}
          />
          <Route
            path={'/admin/monitoring/new'}
            exact
            component={MonitoringFormPage}
          />
          <Route
            path={'/admin/monitoring/:id/edit'}
            exact
            component={MonitoringFormPage}
          />

          <Route
            path={'/admin/model_exchange'}
            exact
            component={Model_exchangeTablePage}
          />
          <Route
            path={'/admin/model_exchange/new'}
            exact
            component={Model_exchangeFormPage}
          />
          <Route
            path={'/admin/model_exchange/:id/edit'}
            exact
            component={Model_exchangeFormPage}
          />
        </Switch>
