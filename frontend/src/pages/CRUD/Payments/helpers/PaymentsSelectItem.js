...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/payments/autocomplete`, { params });
  return response.data;
}

const PaymentsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.payments.hasPermissionToCreate,
});

export default connect(select)(PaymentsSelectItem);
