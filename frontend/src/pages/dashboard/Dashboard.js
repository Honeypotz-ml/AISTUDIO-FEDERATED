          ...
          <Link to={'/admin/algorithms'} style={{ textDecoration: 'none' }}>
            <Widget title={'Algorithms'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Algorithms:{' '}
                  <span className={classes.widgetTextCount}>{algorithms}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/teams'} style={{ textDecoration: 'none' }}>
            <Widget title={'Teams'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Teams:{' '}
                  <span className={classes.widgetTextCount}>{teams}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/federation'} style={{ textDecoration: 'none' }}>
            <Widget title={'Federation'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Federation:{' '}
                  <span className={classes.widgetTextCount}>{federation}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/projects'} style={{ textDecoration: 'none' }}>
            <Widget title={'Projects'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Projects:{' '}
                  <span className={classes.widgetTextCount}>{projects}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/payments'} style={{ textDecoration: 'none' }}>
            <Widget title={'Payments'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Payments:{' '}
                  <span className={classes.widgetTextCount}>{payments}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/training'} style={{ textDecoration: 'none' }}>
            <Widget title={'Training'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Training:{' '}
                  <span className={classes.widgetTextCount}>{training}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/deployment'} style={{ textDecoration: 'none' }}>
            <Widget title={'Deployment'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Deployment:{' '}
                  <span className={classes.widgetTextCount}>{deployment}</span>
                </p>
              </div>
            </Widget>
          </Link>
          ...
          <Link to={'/admin/monitoring'} style={{ textDecoration: 'none' }}>
            <Widget title={'Monitoring'}>
              ...
              >
                ...
                <p className={classes.widgetText}>
                  Monitoring:{' '}
                  <span className={classes.widgetTextCount}>{monitoring}</span>
                </p>
              </div>
            </Widget>
          </Link>
