...
module.exports = class Model_exchangeService {
  static async create(data, currentUser) {
    ...
    try {
      await Model_exchangeDBApi.create(data, {
        currentUser,
        transaction,
      });
  ...
  static async update(data, id, currentUser) {
    ...
    try {
      ...
      if (!model_exchange) {
        throw new ValidationError('model_exchangeNotFound');
      }

      await Model_exchangeDBApi.update(id, data, {
        currentUser,
        transaction,
      });
  ...
  static async remove(id, currentUser) {
    ...
    try {
      ...
      await Model_exchangeDBApi.remove(id, {
        currentUser,
        transaction,
      });
